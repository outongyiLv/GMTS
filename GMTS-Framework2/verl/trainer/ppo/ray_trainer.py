    ...
    def fit(self):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:   
                ...
                """
                1. batch.batch ['attention_mask'] ['input_ids'] ['position_ids'],['prompts'], ['response_mask'] ['responses']
                2. batch.non_tensor_batch : uid, groud-truth and others
                3. batch.meta_info
                """

                ###########################################
                # step1: rollout for sampling
                ...
                with _timer("step", timing_raw):
                    ...
                    ###########################################
                    # step2: calculate old-logp,ref-logp and entropy
                    ...
                    ###########################################
                    # step3: calculate reward and advantage
                    ...
                    with _timer("adv", timing_raw):
                        ...
                        # torch.save(batch, "/rgzn/home/zyw/loty/loty-main/debug/batch_ckpt2.pt") 
                    
                    # need to rank
                    batch = self.reorganize_batch_by_uid(batch) 
                    batch.meta_info['doing_entropy_clipping_type'] = self.config.algorithm.doing_entropy_clipping_type
                    batch.meta_info['doing_entropy_clipping_percent'] = self.config.algorithm.doing_entropy_clipping_percent
