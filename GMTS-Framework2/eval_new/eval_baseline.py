...
def main(
    ...
    tasks: list = ["aime25","aime24","amc", "math", "minerva", "olympiad_bench"], #["aime", "amc", "math", "minerva", "olympiad_bench"]
    template: str = "qwen_math",
    dataset_name: str = "/rgzn/home/zyw/loty/loty-main/eval/evaluation_suite",
    ...
    for seed in seeds:
        for temperature in temperatures:
            ...
            if save:
                fn = "/rgzn/home/zyw/loty/loty-main/eval_result/model_eval_out_" + model_name.replace("/rgzn/home/zyw/loty/loty-main/checkpoints/","").replace("/actor/huggingface","").replace("/", "_") + f"seed{seed}"
